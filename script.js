...
// // // allAnswers.addEventListener("click", function (e) {
// // //   const answerValue = e.target.textContent;
// // //   console.log(answerValue);
// // //   // checkValue(answerValue)
// // // });
...
//   // Score calculation: (correct / total) * 1000
...
// // NEW: Show final results function
...
//   // Add additional stats to modal
//   const statsContainer = document.createElement('div');
//   statsContainer.className = 'game-stats';
//   statsContainer.innerHTML = `
//     <p>Total Questions: ${totalQuestions}</p>
//     <p>Correct Answers: ${score}</p>
//     <p>Wrong Answers: ${totalMisses}</p>
//     <p>Accuracy: ${accuracy}%</p>
//     <p>Final Score: ${gameData.score}</p>
//   `;

//   // Insert stats before restart button
//   const modalContent = modal.querySelector('.modal-content') || modal;
//   modalContent.insertBefore(statsContainer, restartBtn);
      ...
      <div class="results-modal">
        ...
        <div class="results-content">
          <div class="result-card primary-score">
            ...
            <div class="result-value">${gameData.score}</div>
